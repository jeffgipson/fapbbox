...
Public Class saveimage : Implements IHttpHandler
    ...
    Public Sub ProcessRequest(ByVal context As HttpContext) Implements IHttpHandler.ProcessRequest
        ...
        Dim customvalue As String = context.Request.Form("hidcustomval") 'Custom value (optional). If you set "customval" parameter in ContentBox, the value can be read here.
        
        Dim filecover As HttpPostedFile = context.Request.Files("fileCover")
        ...
        CreateCover(filecover, 1600, 1600, rndStr & ".jpg", pagefolder)
        
        'Replace image src with the new saved file
        context.Response.Write("<html><body onload=""parent.applyBoxImage('" & pagefolderpath & rndStr & ".jpg" & "')""></body></html>")
    End Sub
